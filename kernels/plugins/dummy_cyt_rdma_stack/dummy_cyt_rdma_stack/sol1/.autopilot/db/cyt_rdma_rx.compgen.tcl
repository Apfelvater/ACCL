...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { recv_data_TVALID { O 1 bit } recv_data_TREADY { I 1 bit } recv_data_TDEST { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { wr_data_TVALID { O 1 bit } wr_data_TREADY { I 1 bit } wr_data_TDEST { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { wr_cmd_TVALID { O 1 bit } wr_cmd_TREADY { I 1 bit } wr_cmd_TDEST { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rx_TVALID { I 1 bit } rx_TREADY { O 1 bit } rx_TDEST { I 8 vector } } \
} "
} else {
