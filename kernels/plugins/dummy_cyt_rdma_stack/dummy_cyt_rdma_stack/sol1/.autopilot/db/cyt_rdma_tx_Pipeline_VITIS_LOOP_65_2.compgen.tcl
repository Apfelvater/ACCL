...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { send_data_TVALID { I 1 bit } send_data_TDATA { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { send_data_TREADY { O 1 bit } send_data_TDEST { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { tx_TREADY { I 1 bit } tx_TDATA { O 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { tx_TVALID { O 1 bit } tx_TDEST { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_tx_word_dest_V \
    op interface \
    ports { tx_word_dest_V { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { tmp_strb_V_out { O 64 vector } tmp_strb_V_out_ap_vld { O 1 bit } } \
} "
}
