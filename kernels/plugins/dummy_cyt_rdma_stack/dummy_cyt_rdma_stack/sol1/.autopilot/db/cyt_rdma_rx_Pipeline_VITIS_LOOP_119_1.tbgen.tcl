set moduleName cyt_rdma_rx_Pipeline_VITIS_LOOP_119_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {cyt_rdma_rx_Pipeline_VITIS_LOOP_119_1}
...
set portList { 
	...
	{ wr_data_TREADY sc_in sc_logic 1 outacc 5 } 
	...
	{ wr_data_TDATA sc_out sc_lv 512 signal 5 } 
	{ wr_data_TVALID sc_out sc_logic 1 outvld 9 } 
	{ wr_data_TKEEP sc_out sc_lv 64 signal 6 } 
	{ wr_data_TSTRB sc_out sc_lv 64 signal 7 } 
	{ wr_data_TLAST sc_out sc_lv 1 signal 8 } 
	{ wr_data_TDEST sc_out sc_lv 8 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "wr_data_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "wr_data_V_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	wr_data_V_data_V { axis {  { wr_data_TREADY out_acc 0 1 }  { wr_data_TDATA out_data 1 512 } } }
	...
	wr_data_V_dest_V { axis {  { wr_data_TVALID out_vld 1 1 }  { wr_data_TDEST out_data 1 8 } } }
}
