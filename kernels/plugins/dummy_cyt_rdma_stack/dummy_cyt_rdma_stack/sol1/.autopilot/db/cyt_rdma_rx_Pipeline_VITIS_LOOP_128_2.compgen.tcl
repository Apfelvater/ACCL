...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rx_TVALID { I 1 bit } rx_TDATA { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rx_TREADY { O 1 bit } rx_TDEST { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { recv_data_TREADY { I 1 bit } recv_data_TDATA { O 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { recv_data_TVALID { O 1 bit } recv_data_TDEST { O 8 vector } } \
} "
} else {
...
set InstName cyt_rdma_flow_control_loop_pipe_sequential_init_U
set CompName cyt_rdma_flow_control_loop_pipe_sequential_init
