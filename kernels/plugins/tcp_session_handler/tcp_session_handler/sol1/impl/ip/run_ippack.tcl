...
set Library     "ACCL"
set IPName      "tcp_session_handler"
set Version     "1.0"
set DisplayName "Tcp_session_handler"
set Revision    "2113361425"
...
set xo_kernel_name "tcp_session_handler"
set xo_kernel_files {/scratch/hpc-lco-kenter/nleerman/ACCL/kernels/plugins/tcp_session_handler/tcp_session_handler.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/scratch/hpc-lco-kenter/nleerman/ACCL/kernels/plugins/tcp_session_handler/tcp_session_handler/sol1"
set debug_dir "/scratch/hpc-lco-kenter/nleerman/ACCL/kernels/plugins/tcp_session_handler/tcp_session_handler/sol1/.debug"
set xo_hls_files_dir "/scratch/hpc-lco-kenter/nleerman/ACCL/kernels/plugins/tcp_session_handler/tcp_session_handler/sol1/impl/ip/hls_files"
set hdl_module_list {tcp_session_handler_control_s_axi
...
set kernel_xo "/scratch/hpc-lco-kenter/nleerman/ACCL/kernels/plugins/tcp_session_handler/tcp_session_handler.xo"

## Variables
set Top "tcp_session_handler"
set TopNoPrefix "tcp_session_handler"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 ip W 0x0 "Data signal of ip" {{0 32 ip W 0 "Bit 31 to 0 of ip"}}} {0x18 port_nr W 0x0 "Data signal of port_nr" {{0 32 port_nr W 0 "Bit 31 to 0 of port_nr"}}} {0x20 close W 0x0 "Data signal of close" {{0 1 close W 0 "Bit 0 to 0 of close"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 session_id_i W 0x0 "Data signal of session_id_i" {{0 32 session_id_i W 0 "Bit 31 to 0 of session_id_i"}}} {0x30 session_id_o R 0x0 "Data signal of session_id_o" {{0 32 session_id_o R 0 "Bit 31 to 0 of session_id_o"}}} {0x34 session_id_o_ctrl R 0x0 "Control signal of session_id_o" {{0 1 session_id_o_ap_vld R 0 "Control signal session_id_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 success R 0x0 "Data signal of success" {{0 1 success R 0 "Bit 0 to 0 of success"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c success_ctrl R 0x0 "Control signal of success" {{0 1 success_ap_vld R 0 "Control signal success_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control listen_port port_status open_connection close_connection open_status"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
source -notrace "/opt/software/FPGA/Xilinx/Vitis_HLS/2022.2/common/scripts/ipxhls.tcl"
